...
import com.cursoandroid.instagram.activity.ComentariosActivity;
...
public class AdapterFeed extends RecyclerView.Adapter<AdapterFeed.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        Uri uriFotosUsuario = Uri.parse( feed.getFotoUsuario() );
        Uri uriFotosPostagem = Uri.parse( feed.getFotoPostagem() );

        Glide.with( context ).load( uriFotosUsuario ).into(holder.fotoPerfil);
        Glide.with( context ).load( uriFotosPostagem).into(holder.fotoPostagem);
